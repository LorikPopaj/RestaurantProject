...
<body onscroll="disableScrolling()" onmousewheel="enableScrolling()" onclick="enableScrolling()">
		...
		<div class="container" style="display:flex; flex-direction: column">
            ...
            <a href="createCoc.php"><button>Create</button></a>
            ...
            <div>
                ...
                <tr>
                    ...
                    <td><a href='deleteCoc.php?ID=<?php echo $column['ID'];?>'>Delete</td>
                    <td><a href='editCoc.php?ID=<?php echo $column['ID'];?>'>Edit</td>
                </tr>
                <?php endforeach; ?> 
                    </tbody>
                </table>
