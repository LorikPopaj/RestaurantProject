...
<body onscroll="disableScrolling()" onmousewheel="enableScrolling()" onclick="enableScrolling()">
		...
		<div class="container" style="display:flex; flex-direction: column">
            ...
            <a href="createS.php"><button>Create</button></a>
            ...
            <div>
                ...
                <?php
                $s = new SlideController;
                $slideList = $s->readData();
                foreach($slideList as $slide): ?>
                <tr>
                    <td><?php echo $slide['img']; ?></td>
                    <td><a href='deleteS.php?ID=<?php echo $slide['ID'];?>'>Delete</td>
                    <td><a href='editS.php?ID=<?php echo $slide['ID'];?>'>Edit</td>
                </tr>
                <?php endforeach; ?> 
                    </tbody>
                </table>
